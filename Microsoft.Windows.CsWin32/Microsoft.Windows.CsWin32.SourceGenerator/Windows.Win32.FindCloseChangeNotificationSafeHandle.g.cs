...
namespace Windows.Win32
{
	...
	/// <summary>
	/// Represents a Win32 handle that can be closed with <see cref="PInvoke.FindCloseChangeNotification"/>.
	/// </summary>
	[global::System.CodeDom.Compiler.GeneratedCode("Microsoft.Windows.CsWin32", "0.2.104-beta+6d86f35b75")]
	internal class FindCloseChangeNotificationSafeHandle
		:SafeHandle	{
		...
		protected override bool ReleaseHandle() => PInvoke.FindCloseChangeNotification((winmdroot.Storage.FileSystem.FindChangeNotificationHandle)this.handle);
	}
}
