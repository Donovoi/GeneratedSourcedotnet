...
namespace Windows.Win32
{
	namespace UI.Input
	{
		...
		internal partial struct RAWINPUT
		{
			...
			/// </summary>
			internal winmdroot.UI.Input.RAWINPUTHEADER header;
			/// <summary></summary>
			internal winmdroot.UI.Input.RAWINPUT._data_e__Union data;
			...
			{
				[FieldOffset(0)]
				internal winmdroot.UI.Input.RAWMOUSE mouse;
				[FieldOffset(0)]
				internal winmdroot.UI.Input.RAWKEYBOARD keyboard;
				[FieldOffset(0)]
				internal winmdroot.UI.Input.RAWHID hid;
			}
		}
	}
}
