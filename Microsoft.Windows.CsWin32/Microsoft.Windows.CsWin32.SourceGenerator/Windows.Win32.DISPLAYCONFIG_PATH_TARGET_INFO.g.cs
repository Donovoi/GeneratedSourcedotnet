...
namespace Windows.Win32
{
	namespace Devices.Display
	{
		...
		internal partial struct DISPLAYCONFIG_PATH_TARGET_INFO
		{
			...
			internal uint id;
			internal winmdroot.Devices.Display.DISPLAYCONFIG_PATH_TARGET_INFO._Anonymous_e__Union Anonymous;
			...
			internal winmdroot.Devices.Display.DISPLAYCONFIG_VIDEO_OUTPUT_TECHNOLOGY outputTechnology;
			...
			internal winmdroot.Devices.Display.DISPLAYCONFIG_ROTATION rotation;
			...
			internal winmdroot.Devices.Display.DISPLAYCONFIG_SCALING scaling;
			...
			internal winmdroot.Devices.Display.DISPLAYCONFIG_RATIONAL refreshRate;
			...
			/// </summary>
			internal winmdroot.Foundation.BOOL targetAvailable;
			...
			internal partial struct _Anonymous_e__Union
			{
				...
				[FieldOffset(0)]
				internal winmdroot.Devices.Display.DISPLAYCONFIG_PATH_TARGET_INFO._Anonymous_e__Union._Anonymous_e__Struct Anonymous;
