...
namespace Windows.Win32
{
	namespace Storage.FileSystem
	{
		...
		internal readonly partial struct FindVolumeHandle
			: IEquatable<FindVolumeHandle>
		{
			internal readonly IntPtr Value;
			internal FindVolumeHandle(IntPtr value) => this.Value = value;

			internal static FindVolumeHandle Null => default;
			...
			public static bool operator ==(FindVolumeHandle left, FindVolumeHandle right) => left.Value == right.Value;
			public static bool operator !=(FindVolumeHandle left, FindVolumeHandle right) => !(left == right);
